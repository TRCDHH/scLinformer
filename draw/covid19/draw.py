...
# ---------------------- CUSTOM PARAMETERS ----------------------
PERTURB_GENE = 'IL6'
CSV_PATH = "/home/output/newcovid/IL6/enrichment/go_enrichment.csv"
...
# %% [3] Load and Filter Significant Data
...
# %% [4] Data Sorting and Transformation
...
# %% [6] Dynamic Figure Size and Global Plot Settings
...
# %% [8] Axis Labels and Plot Styling
ax.set_yticks(y)
